      ...
      <div className="container-custom">
        <div className="flex h-16 items-center justify-between">
          ...
          <Link to="/" className="flex items-center space-x-2">
            <span className="text-2xl font-bold text-primary-500">MyDrZone</span>
          </Link>
          ...
          <nav className="hidden items-center space-x-1 md:flex">
            ...
            <button className="btn-outline btn-sm rounded-full px-3 py-1">
            ...
            <Link to="/profile" className="flex items-center space-x-2 rounded-full px-2 py-1 hover:bg-gray-100">
